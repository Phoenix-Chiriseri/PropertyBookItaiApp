...
Route::get('/addService', [App\Http\Controllers\ServicesController::class, 'addServicesScreen']); 
Route::get('/addPrice', [App\Http\Controllers\ServicesController::class, 'addPriceScreen']); 
...
Route::post('/postServiceData', [App\Http\Controllers\ServicesController::class, 'postService']); 
Route::post('/postPriceData', [App\Http\Controllers\ServicesController::class, 'postPrice']); 
