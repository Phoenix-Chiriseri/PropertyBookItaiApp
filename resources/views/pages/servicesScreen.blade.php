...
@section('content')
    ...
    <tr>
      ...
      <th scope="col"><a href = "/addService" class = "btn btn-info">Add New Service</a></th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr>
      ...
      <td><a href = "/editService/{{$service->id}}" class = "btn btn-danger"><i class = "fa fa-book-open"></i> Edit Service</a></td>
    </tr>
    @endforeach
    <!--<tr>
      <th scope="row">1</th>
