...
@section('content')
  ...
  <tbody>
    ...
    <tr>
      <td>{{$price->price}}</td>
      <td><a href = "/price/{{$price->id}}" class = "btn btn-danger"><i class = "fa fa-book-open"></i>Edit Price</a></td>
       <!--<td><a href = "/deletePrice/{{$price->id}}" class = "btn btn-danger"><i class = "fa fa-book-open"></i>Delete Price</a></td>!-->
    </tr>
    @endforeach
    <!--<tr>
      <th scope="row">1</th>
    ...
    <div class="fixed-plugin">
        <!--<a class="fixed-plugin-button text-dark position-fixed px-3 py-2" href = "/logout">Logout
