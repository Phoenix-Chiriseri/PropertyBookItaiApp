  ...
  <nav class="navbar navbar-expand-lg navbar-dark primary-color-dark">
      <a class="navbar-brand" href="/dashboard"><strong>Neil Properties</strong></a>
    ...
    <div class="container-fluid py-4">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                <form action="{{ url('/updatePrice',$price->id) }}" method="POST" class="form-horizontal">
                        @csrf
                        @method('PUT') 
                        ...
                        <div class="card-body">
                            <p class="text-uppercase text-sm">Edit Price</p>
                            <div class="row">
                                <div class="col-md-6">
